    ...
    <div class="container">
      ...
      <div class="left-display">
          ...
          <div class="post-section">
              <form action="{{route('newPost', auth()->user()->id)}}" method="post">
                @csrf
            ...
            <tbody>
              @foreach($posts as $post)
                <tr>
                  ...
                  <td><a href="{{route('edit', $post->id)}}" id="edit-btn" class="post-btn">Edit</a></td>
                  <td><a href="{{route('delete', [$post->id, auth()->user()->id])}}" id="delete-btn" class="post-btn">Delete</a></td>
                </tr>
              @endforeach
            </tbody>
        </table>
